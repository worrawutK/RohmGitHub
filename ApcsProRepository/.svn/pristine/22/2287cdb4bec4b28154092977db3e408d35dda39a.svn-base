...
{
    public partial class InputAssySlip332Dialog : Form
    {
        private Boolean c_IsDone = false;
        private AssySlip332 c_InputValue;
        public AssySlip332 InputValue 
        {
            get { return c_InputValue; }
            set { c_InputValue = value; }
        }

        public InputAssySlip332Dialog()
        {
            InitializeComponent();
        }
        ...
        private void DisplayData()
        {
            ...
            LabelDcCode.Text = c_InputValue.DcCode;
            LabelPlasma.Text = c_InputValue.Plasma;
            LabelChipThickness.Text = c_InputValue.ChipThickness;
        ...
        private void InputAssySlip332Dialog_Load(object sender, EventArgs e)
        {
            c_InputValue = new AssySlip332();
        ...
        private void TextBoxQrCodeInput_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                try
                {
                    AssySlip332 dummy = new AssySlip332();
