    ...
    public partial class KeyboardControl : UserControl
    {
        ...
        public BoW KeyboardType
        {
            ...
            set
            {
                ...
                {
                    pictureBoxKeyboard.Image = Rohm.Common.Forms.Properties.Resources.KeyboardWhite;
                    pictureBoxCapsLockDown.Image = Rohm.Common.Forms.Properties.Resources.CapsDownWhite;
                    pictureBoxLeftShiftDown.Image = Rohm.Common.Forms.Properties.Resources.ShiftDownWhite;
                    pictureBoxRightShiftDown.Image = Rohm.Common.Forms.Properties.Resources.ShiftDownWhite;
                }
                else if (pvtKeyboardType == BoW.Alphabetical)
                {
                    pictureBoxKeyboard.Image = Rohm.Common.Forms.Properties.Resources.KeyboardAlphabetical;
                    pictureBoxCapsLockDown.Image = Rohm.Common.Forms.Properties.Resources.CapsDownWhite;
                    pictureBoxLeftShiftDown.Image = Rohm.Common.Forms.Properties.Resources.ShiftDownWhite;
                    pictureBoxRightShiftDown.Image = Rohm.Common.Forms.Properties.Resources.ShiftDownWhite;
                }
                ...
                {
                    pictureBoxKeyboard.Image = Rohm.Common.Forms.Properties.Resources.KeyboardKidsLower;
                }
            }
        }
        ...
        private void HandleCapsLock()
        {
            if (capslockindicator)
            {
                ...
                if (pvtKeyboardType == BoW.Kids) pictureBoxKeyboard.Image = Rohm.Common.Forms.Properties.Resources.KeyboardKidsLower;
            }
            else
            {
                capslockindicator = true;
                if (pvtKeyboardType == BoW.Kids) pictureBoxKeyboard.Image = Rohm.Common.Forms.Properties.Resources.KeyboardKidsUpper;
