...
{
   public class AssySlip332
    {
        public void ReadFromQrString(string fullQrCode)
        {
            if (fullQrCode.Length != 332)
            {
            ...
            this.Symbol_4 = FullCode.Substring(252, 10).Trim();
            this.Symbol_5 = tempFullQrCode.Substring(262, 10).Trim();
            this.Symbol_6 = tempFullQrCode.Substring(272, 10).Trim();
            this.DcCode = tempFullQrCode.Substring(282, 4).Trim();
            this.Plasma = tempFullQrCode.Substring(286, 2).Trim();
            this.ChipThickness = tempFullQrCode.Substring(288, 3).Trim();
            this.Spare = tempFullQrCode.Substring(291, 41).Trim();
        }
