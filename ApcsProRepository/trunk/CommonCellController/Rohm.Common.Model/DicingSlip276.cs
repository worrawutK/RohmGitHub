...
namespace Rohm.Common.Model
{
    public class DicingSlip276
    {
        ...
        //    FullCode = qrcode
        //End Sub
        public DicingSlip276(string qrcode)
        {
            FullCode = qrcode;
        }
        void SeperateData(string wfSlip)
        {
            if (wfSlip.Length == 276)
            {
                ...
                OrderNo = wfSlip.Substring(254, 12).Trim();
                DCCode = wfSlip.Substring(266, 4).Trim();
                Plasma = wfSlip.Substring(270, 1).Trim();
                CodeNo = wfSlip.Substring(271, 5).Trim();
